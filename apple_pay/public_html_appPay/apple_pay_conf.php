...
define('PRODUCTION_CERTIFICATE_KEY', '/var/www/sdomains/ecoms/alaswad.scdwapps.com/applepay_includes/ApplePay.key.pem');
define('PRODUCTION_CERTIFICATE_PATH', '/var/www/sdomains/ecoms/alaswad.scdwapps.com/applepay_includes/apple-pay-cert.pem');

// This is the password you were asked to create in terminal when you extracted ApplePay.key.pem
 define('PRODUCTION_CERTIFICATE_KEY_PASS', 'test'); 
...
define('PRODUCTION_MERCHANTIDENTIFIER', 'merchant.alaswad.scdwapps');
...
// if the line above isn't working for you, replace it with the one below, updating it for your own domain name
 define('PRODUCTION_DOMAINNAME', 'alaswad.scdwapps.com');
...
define('PRODUCTION_DISPLAYNAME', 'alaswad');
