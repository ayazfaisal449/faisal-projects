...
<div class="form-wrapper">
    ...
    <div class="row">
        <div class="large-7 columns">
            ...
            {!!Form::text('job_role',$jobs->job_role)!!}
        </div>
    </div>
    <div class="row">
        <div class="large-7 columns">
    ...
    <div class="row">
        <div class="large-12 columns">
            ...
            @if($jobs->location)
               <img style="max-height: 300px; margin-top: 40px; margin-bottom: 40px;" src="{!! Request::root() !!}/{!!$jobs->location!!}">
           @else
               <img style="max-height: 300px; margin-top: 40px; margin-bottom: 40px;" src="{!! Request::root() !!}/images/no_image.png">
        @endif
        </div>
    </div>
    ...
    <div class="row">
        <div class="large-7 columns">
            ...
            {!!Form::textarea('description',$jobs->description)!!}
        </div>
    </div>
    ...
    <!-- <div class="row">
        <div class="large-7 columns">
            ...
            {!!Form::text('sort',$jobs->sort_order)!!}
        </div>
    </div> -->
