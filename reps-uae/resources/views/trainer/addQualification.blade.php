...
@section('content')
    ...
    <div class="row">
        <div class="large-12 columns trainer_qualification">
            ...
            <div class="qualification">
                 ...
                 <div class="large-6 columns">
                     ...
                     <div class="inputWrapper">
                        ...
                        {!!Form::text('course_name[]',(isset($oldData[0]['course_name'])?$oldData[0]['course_name']:''), ['placeholder' => 'Enter the course name here']) !!}
                    </div>
                    ...
                    <div class="inputWrapper">
                        ...
                        {!!Form::label('course_provider', 'Name of Institution')!!}
                         ...
                         {!!Form::text('course_provider[]',(isset($oldData[0]['course_provider'])?$oldData[0]['course_provider']:''), ['placeholder' => 'Enter the institution name here']) !!}
                    </div>
                    ...
                    <div class="inputWrapper">
                        ...
                        {!!Form::label('date_completed', 'Date Completed')!!}
                         ...
                         {!! Form::text('date_completed[]', (isset($oldData[0]['date_completed']) ? $oldData[0]['date_completed'] : ''), ['class' => 'dateC', 'autocomplete' => 'off']) !!}
                    </div>
                </div>
    ...
    <i>Recommended file types: png, jpg, jpeg, gif</i><br>
    <i>Limit size to 2MB for each file</i>
    <label for="certificates0">
        <div class="upload"></div>
    </label>
    {!! Form::file('certificates0[]', ['class' => 'certificates','id' => 'certificates0','multiple' => 'multiple','onchange' => 'validateCertificateFile(this)','accept' => 'image/*']) !!}
                    ...
                    <div class="qualification">
                        ...
                        <div class="large-6 columns">
                            ...
                            <div class="inputWrapper">
                                ...
                                {!! Form::text('course_name[]', (isset($oldData[$i]['course_name']) ? $oldData[$i]['course_name'] : ''), ['placeholder' => 'Enter the course name here']) !!}
                            </div>
                            ...
                            <div class="inputWrapper">
                                <div class="label">
                                 ...
                                 {!!Form::text('course_provider[]',(isset($oldData[$i]['course_provider'])?$oldData[$i]['course_provider']:''), ['placeholder' => 'Enter the institution name here'])!!}
                            </div>
                            ...
                            <div class="inputWrapper">
                                <div class="label">
                                 ...
                                 {!! Form::text('date_completed[]', (isset($oldData[$i]['date_completed']) ? $oldData[$i]['date_completed'] : ''), ['class' => 'dateC', 'autocomplete' => 'off']) !!}
                            </div>
                        </div>
                        <div class="large-6 columns">
                            ...
                            {!! Form::file('certificates0[]', ['class' => 'certificates','id' => 'certificates0','multiple' => 'multiple','accept' => 'image/*']) !!}
                            <div class="filename"></div>
                        </div>
    ...
    <div class="trainerSubTitle">
        <div class="row">
            <div class="large-4 columns">
                <div class="errorWrapper">
                    <h3>Upload First Aid Certificate</h3>
    ...
    <div class="row">
        <div class="large-12 columns">
            ...
            {!! Form::file('aid', ['id' => 'aid', 'accept' => '.pdf,.doc,.docx']) !!}
            <span class="filename aid"></span>
        </div>
    </div>
        ...
        <div class="row">
            <div class="medium-8 medium-offset-2 columns">
                ...
                <div class="termsz">
                    ...
                    <ul class="openSans">
                        <li>To follow REPs Code of Ethical Practice (a copy can be downloaded at www.repsuae.com) and to be bound by any REPs complaints process.</li>
                        <li>That all information provided on this form is accurate and true.</li>
                        <li>That REPs have permission to contact any third party to verify any details of my registration application. To also allow to pass on any contact details to third parties that provide services, and for them to contact me.</li>
                        ...
                        <li>To undertake sufficient ongoing education (Continuing Professional Development). 20 CPD points over 2 years.</li>
                        <li>To maintain a current email address at all times, and receive all email communications from REPs UAE.</li>
                        <li>All payments for registration are for 12 months. Refunds are not given for change of mind, unsuccessful registration, or failure to meet registration standards.</li>   
                        <li>This agreement is between the applicant as detailed in section 1, and the UAE Register of Exercise Professionals.</li>
                    </ul>
                </div>
                <?php
            ...
            <div class="medium-4 large-offset-8 columns">
                ...
                <!-- <a type="submit" class="submitBtn" style="margin-top: 0;">Checkout</a> -->
...
@section('customScripts')
    ...
    $('.moreQualification .qualification').each(function (index) {
        ...
        if ($(this).find('.remove').length == 0) {
            ...
            $(this).find('.remove').click(function () {
                ...
                // Check if count is less than 5 and show the 'Add' button
                if ($count < 5) {
                    $('#more').show();
                }
            });
    ...
    function addQualification() {
        ...
        if ($count < 5) {
            ...
            $count++;
               if ($count >= 5) {
            $('#more').hide(); // Hide the 'Add' button when the limit is reached
        }
        }
    ...
    function validateCertificateFile(inputElement) {
        var file = inputElement.files[0];
        var fileExtension = ['png', 'jpeg', 'jpg', 'gif'];

        if ($.inArray(inputElement.value.split('.').pop().toLowerCase(), fileExtension) == -1) {
