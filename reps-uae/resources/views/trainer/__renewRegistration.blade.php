        ...
        <div class="row">
            <div class="large-12 columns">
                ...
                @if ($expire_dt_wgp < $today_dt)
                    <p style="color:red;">
                        Your membership has expired on:&nbsp;&nbsp;<strong>{{ $expire_dt->format('d-m-Y') }}!</strong>&nbsp;&nbsp;
                        Renew now to continue your REPs membership!
                    </p>
                    <p style="color:red;">
                        Renewal fee is AED {{ Config::get('subscriptionPayment.renewal_amount') }} for 12 months of membership. You may renew prior to your date of expiry, failing to renew within the 30 day grace period will incur a AED 100 penalty fee. Date of expiry following renewal will be one year from original expiry date, not one year from renewal payment date.
                    </p>
                ...
                @else
                    <p>
                        Your membership will expire on:&nbsp;&nbsp;<strong>{{ $expire_dt->format('d-m-Y') }}</strong>.&nbsp;&nbsp;Renew now! 
                    </p>
                    <p>
                        Renewal fee is AED {{ Config::get('subscriptionPayment.renewal_amount') }} for 12 months of membership. You may renew prior to your date of expiry, failing to renew within the 30 day grace period will incur a AED 100 penalty fee. Date of expiry following renewal will be one year from original expiry date, not one year from renewal payment date.
                    </p>
        ...
        <div class="continueBtnWrapper">
            <div class="row">
                <div class="small-12 columns end">
                    <br />
                    <h3 style="font-family: HelveticaNeueLTCom-Th;">Cannot renew.  You currently have a pending renewal awaiting admin approval.</h3>
                </div>
            </div>
        </div>
    @else
        <div class="continueBtnWrapper">
            ...
            <div class="row">
                ...
                <div class="medium-4 columns">
                    <p class="payType">
                        <a class="payTypeO" href="#"><img style="border: 3px solid #10984b;" src="{{Request::root()}}/img/paytype-online.png" class="onpy" /></a><br />
                    </p>
                        ...
                        <ul class="paySteps">
                            <li>
                                ...
                                @if (Session::has('message2'))
                                    <br />
                                    <div class="subnotify" style="padding:15px 15px 0px 15px;color:red;font-family:'HelveticaLTStd-BoldCond';">
                            ...
                            <li style="margin-top:12px;">
                                ...
                                @if ($expire_dt_wgp < $today_dt)
                                    Pay the Dhs525 (VAT incl.) membership fee.
                                @else
                                    Pay the Dhs420 (VAT incl.) membership fee.
                                @endif
                                <br /><br />
                ...
                <div class="medium-4 columns end">
                    <p class="payType">
                        <a class="payTypeC" href="#"><img src="{{Request::root()}}/img/paytype-cash.png" class="cashpy" /></a><br />
                    </p>
                    <p style="font-size:16px;">
                        <span style="color:#32A543;font-family:'HelveticaLTStd-BoldCond';">PAY CASH.</span> Please bring to the REPs office AED @if ($expire_dt_wgp < $today_dt) 525 @else 420 @endif membership fee plus any certificates from any courses or events you have attended in the past 12 months.
                    </p>
                </div>
            </div>
        </div>
        ...
        <div id="dlgCashPay" title="Cash Payment" style="display:none;">
            <p>
                Please bring to the REPs office AED @if ($expire_dt_wgp < $today_dt) 525 @else 420 @endif membership fee plus any certificates from any courses or events you have attended in the past 12 months.
            </p>
        </div>
    @endif
