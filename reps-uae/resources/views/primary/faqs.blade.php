    ...
    <div class="row">
        <div id="faqsImage" class="small-12 columns">
            <div id="faqsImageWrapper">
                <img src="{{ asset('img/question.png') }}" alt="Frequently Asked Questions" id="">
        ...
        <div>&nbsp;</div>
        <div>&nbsp;</div>
        <div style="display:none;" class="small-12 columns">
            <div class="questionItem">
                <p class="question">
                    What is REPs?
                </p>
            ...
            <div class="questionItem">
                ...
                <div class="answer">
                    <p>
                    Dubai Sports Council, and more recently the Abu Dhabi Sports Council have issued circulars to all health clubs that registration with REPs UAE for all instructors is mandatory. Checks may be carried out on Clubs through the Sports Councils. 
                    </p>
                    <p>
                    Regardless of the legal situation REPS UAE encourages all instructors to register and calls on all employers to back REPs to increase professionalism in the industry.
                    </p>
                    <p>
                    ...
                    <ul style="font-size: 14px;">
                        ...
                        <li>is committed to on going professional development</li>
                    </ul>
                    <p>
                        We strongly recommend that members of the public looking to employ the services of an exercise professional check to see if they are registered by searching our member database.
                    </p>
                </div>
            </div>
            {{-- <div class="questionItem">
                ...
                <div class="answer">
                    <p>
                        <table class="table table-striped">
                            <tr>
                                <td>A: Personal Trainer</td>
                                <td>F: Pilates Instructor</td>
                            </tr>
                            <tr>
                                <td>B: Gym Instructor</td>
                                <td>G: Pilates Instructor Comprehensive</td>
                            </tr>
                            <tr>
                                <td>C: Group Fitness Instructor</td>
                                <td>H: Aqua Fitness Instructor</td>
                            </tr>
                            <tr>
                                <td>D: Group Fitness Instructor Freestyle</td>
                                <td>I: Children's Fitness Instructor</td>
                            </tr>
                            <tr>
                                <td>E: Yoga Instructor</td>
                                <td><!--J: Assistant Instructor--></td>
                            </tr>
                        </table>
                    </p>
                </div>
            ...
            <div class="questionItem">
                <p class="question">
                    Is there a category for Advanced Personal Trainer on REPs?
                </p>
                <div class="answer">
                    <p>
                    No, not at the moment, we are concentrating on getting trainers qualified as Gym Instructors and Personal Trainers first. Also there is not an agreed advanced (Level 4) criteria around the world so it makes it hard to develop an Advanced category in the UAE when different training companies and instructors use different advanced courses from around the world. For Gym Instructor and Personal Trainer there is more or less a global consensus on the skills needed for these job roles.
                    </p>
                </div>
            </div>
            <div class="questionItem">
            ...
            <div class="questionItem">
                ...
                <div class="answer">
                    <p>
                        In order to become a fitness professional and register with REPs you must hold a recognised qualification from an approved training provider. To search for approved training providers go to the <b>Approved Training</b> part of the website.
                    </p>
                </div>
            </div>
            <div class="questionItem">
            ...
            <div class="questionItem">
                ...
                <div class="answer">
                    <p>
                       It costs Dhs420 (VAT incl.) per year to be a member of REPs UAE
                    </p>
                </div>
            </div>
            <div class="questionItem">
