                                	...
                                	<table border="0" cellpadding="0" cellspacing="0" width="600" id="templateHeader">
                                        <tr>
                                            <td class="headerContent">
                                            	...
                                            	<img src="http://www.repsuae.com/img/insuranceBg.jpg" style="max-width:600px;" id="headerImage campaign-icon" mc:label="header_image" mc:edit="header_image" mc:allowdesigner mc:allowtext />
                                                	...
                                                	<tr>
                                                    	<td valign="top" class="sidebarContent">
                                                            ...
                                                            <table border="0" cellpadding="20" cellspacing="0" width="100%">
                                                                <tr mc:repeatable>
                                                                    <td valign="top">
                                                                        <img src="http://www.repsuae.com//img/logo.png" style="max-width:160px;" mc:label="image" mc:edit="tiwc200_image00" />
                                                                            ...
                                                                            <tr>
                                                                                <td valign="top">
						                                                            <div mc:edit="std_content00">
						                                                                <h1 class="h1">Hi Reps Admin,</h1>
						                                                                <h2 class="h2">Someone filled up for an Insurance.</h2>
						                                                                
						                                                                <strong>Details:</strong><br />

						                                                               	<p>Membership Number: {{$membership_number}}</p>
<p>Name: {{$name}}</p>
<p>Email: {{$email}}</p>
...
<p>Date of Birth: {{$birthdate}}</p>
						                                                               	...
						                                                               	<br />
						                                                                <p>Type of Qualification: {{$quality_type}}</p>
						                                                                <p>Year Qualified: {{$year_qualified}}</p>
						                                                                <p>Country Qualification: {{$country_qualified}}</p>

						                                                                <p>Address: {{$address}}</p>
						                                                                <p>Emirates: {{$emirates}}</p>
						                                                                <p>PO Box: {{$po_box}}</p>
						                                                                <p>
						                                                                	Do you suffer from any disabilities, transmittable diseases (e.g. hepatitis, HIV, etc.) or other impediment which may affect the performance of your professional duties as a fitness trainer?
						                                                                	<br />
						                                                                	<b>Answer is&nbsp;{{$is_disable}}</b>
						                                                                </p>
						                                                                <p>
						                                                                	Have you been the subject of or convicted of any criminal offence (other than minor traffic offences), professional disciplinary proceedings, or inquiries?
						                                                                	<br />
						                                                                	<b>Answer is&nbsp;{{$is_criminal}}</b>
						                                                                </p>
						                                                                <p>
						                                                                	Have any claims for injury or professional negligence been made against you during the last 3 years?
						                                                                	<br />
						                                                                	<b>Answer is&nbsp;{{$is_injury}}</b>
						                                                                </p>
						                                                                <p>
						                                                                	Has any insurer previously declined to accept, cancelled, refused to continue or agreed to continue only on special terms, in respect of this type of insurance?
						                                                                	<br />
						                                                                	<b>Answer is&nbsp;{{$is_insurer}}</b>
						                                                                </p>
