...
?>
            ...
            <div class="large-12 columns">
                ...
                <div class="large-12 columns">
                    ...
                    <label for="aid" style="padding-left:0px;">
                        <div class="upload"></div>
                    </label>
                    
                    <div class="clearfix"></div>
                    {!!Form::file('aid',array('id'=>'aid'))!!}
                    <span class="filename aid"></span>
                    @if (!empty($aid))
                        <a href="/trainer/{!!$data['id']!!}/aid/{!!$aid!!}" target="_blank" style="font-size:13px;">Current Aid File:  <span style="text-decoration:underline;">{!!$aid!!}</span></a>
                    @else
                        <span style="font-size:12px;">Current Aid File:  <strong style="color:#c0c0c0;">No uploaded Aid on file.</strong></span>
                    @endif
                </div>
            </div>
            </div>
