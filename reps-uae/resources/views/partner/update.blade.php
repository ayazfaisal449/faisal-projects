  ...
  <script>tinymce.init({ selector:'textarea' });</script>
    <div class="tools">
        ...
        {!!Form::open(array(
            'files'=> true, 
            'name' => 'AddNewSlider',
            'url' => Request::root().'/admin/partner/save',
            'class' => 'addForm'
        ))!!}
            ...
            <div class="form-wrapper">
                ...
                <div class="row">
                    <div class="large-7 columns">
                        ...
                        {!!Form::text('button_text',$partner->button_text)!!}
                    </div>
                </div>
                 <div class="row">
                    <div class="large-7 columns">
                 ...
                 <div class="row">
                    <div class="large-12 columns">
                      {!!Form::label('current', 'Current Image')!!}
                        <img style="max-height: 300px; margin-top: 40px; margin-bottom: 40px;" src="{!!Request::root()!!}/{!!$partner->location!!}">
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="large-7 columns">
                        ...
                        {!!Form::text('sort',$partner->sort_order)!!}
                    </div>
                </div>
