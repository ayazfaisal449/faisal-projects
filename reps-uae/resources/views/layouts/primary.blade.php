...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    <head>
        ...
        <link media="all" type="text/css" rel="stylesheet" href="https://ruae.scdwapps.com/css/intlTelInput.css">
        <script src="{{ asset('js/admin/jquery-1.7.2.js') }}"></script>
        <script src="{{ asset('js/vendor/modernizr-2.6.2.min.js') }}"></script>
        
        <link rel="stylesheet" href="{{ asset('css/stylesheets/app.css?v=2') }}">
        ...
        <link rel="stylesheet" href="{{ asset('src_new/app.min.css') }}">
        <link rel="stylesheet" href="{{ asset('src_new/responsive.css?v=1') }}">
        <link rel="stylesheet" href="{{ asset('src_new/font-awesome.min.css') }}">
...
<!-- 
       ...
       <link rel="stylesheet" href="{{ asset('css/stylesheets/benefit.css') }}">
        ...
        <nav class="pushmenu pushmenu-left">
            <div class="menu-right">
                ...
                <ul class=" clearfix" >
					...
					<li>
                        <a href="{{Request::root()}}/jobs">Jobs</a>
                    </li>
                ...
                <ul class="sub-mobile clearfix">
                    ...
                    <li>
                        <a href="{{ action('PrimaryController@ethics') }}"><span>Code of Ethics<span></a>
                                    ...
                                    <script src="{{ asset('src_new/slick.min.js') }}"></script>
                                    ...
                                    <script src="https://ruae.scdwapps.com/js/intlTelInput-jquery.min.js"></script> 
